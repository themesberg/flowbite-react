...
Please note you will need to understand how to use a terminal/command prompt, Git and Node.js to be able to contribute.

The library is written in React TypeScript, and uses Tailwind CSS. You should be familiar with all of them. You should also understand CI/CD, because contributions you make will be automatically verified with tools like ESLint and Prettier.
...
9. Go to [the repository](https://github.com/themesberg/flowbite-react) and [create a Pull Request](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request). Don't forget to follow the Pull Request template, which will be available automatically to fill out.

### Improving The Documentation

The [documentation at flowbite-react.com](https://flowbite.com) can all be found inside the `app` folder of this repository. It's written in [Next.js](https://nextjs.org/), and we use [Markdown](https://www.markdownguide.org/cheat-sheet/) for almost all of the content, so you don't need to even be able to write React TypeScript to make documentation changes!
