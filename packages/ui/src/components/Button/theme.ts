...
export const buttonTheme: ButtonTheme = createTheme({
  ...
  color: {
    ...
    gray: "border border-gray-200 bg-white text-gray-900 focus:text-cyan-700 focus:ring-4 focus:ring-gray-700 enabled:hover:bg-gray-100 enabled:hover:text-cyan-700 dark:border-gray-600 dark:bg-transparent dark:text-gray-400 dark:enabled:hover:bg-gray-700 dark:enabled:hover:text-white",
