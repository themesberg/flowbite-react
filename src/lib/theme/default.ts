...
const theme: FlowbiteTheme = {
  ...
  tab: {
    ...
    tablist: {
      ...
      tabitem: {
        base: 'flex items-center justify-center p-4 text-sm font-medium first:ml-0 disabled:cursor-not-allowed disabled:text-gray-400 disabled:dark:text-gray-500 focus:outline-0',
        styles: {
          default: {
            base: 'rounded-t-lg',
            active: {
