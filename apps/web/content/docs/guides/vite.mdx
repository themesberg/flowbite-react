...
Run the following command to scaffold a new `Flowbite React` project using `Vite`:
...
# pnpm
pnpm create flowbite-react --template vite

# bun
bun create flowbite-react --template vite
```
