...
import { Textarea, Label, Button, theme } from '~/src';
...
<CodePreview importFlowbiteReact="Textarea, Label" title="Textarea example">
  <div>
...
<CodePreview importFlowbiteReact="Textarea, Button, Label" title="Textarea example">
...
<CodePreview importFlowbiteReact="Textarea, Button, Label" title="Textarea example">
  <form>
    ...
    <div className="flex items-center rounded-lg bg-gray-50 px-3 py-2 dark:bg-gray-700">
      ...
      <Textarea id="chat" rows="1" className="mx-4 block w-full p-2.5 text-sm" placeholder="Your message..."></Textarea>
      <button
        type="submit"
...
<pre className="language-tsx">
  <code>{JSON.stringify(theme.textarea, null, 2)}</code>
</pre>

## References

- [Flowbite File Input](https://flowbite.com/docs/forms/textarea/)
