...
<CodePreview importFlowbiteReact="Checkbox, Label" title="Bordered checkbox">
...
<CodePreview importFlowbiteReact="Checkbox, Label" title="Checkbox list group">
  <div>
...
<CodePreview importFlowbiteReact="Checkbox, Label" title="Horizontal list group">
  <div>
...
<CodePreview
  importExternal="import { MdSearch } from 'react-icons/md';"
  importFlowbiteReact="Checkbox, Label, Dropdown, TextInput"
...
>
  <div className="flex items-center justify-center">
    <Dropdown label="Dropdown search" dismissOnClick={false} className="z-50">
      ...
      <Dropdown.Divider />
      <Dropdown.Item className="font-medium text-red-600">
        <svg
          ...
          viewBox="0 0 20 18"
        >
          <path d="M6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM8 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Zm11-3h-6a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2Z"></path>
        </svg>
        Delete user
      </Dropdown.Item>
    </Dropdown>
...
<CodePreview importFlowbiteReact="Checkbox, Label" title="Inline layout">
  <div className="flex items-center gap-6">
    <div className="flex items-center gap-2">
...
<CodePreview importFlowbiteReact="Checkbox, Label" title="Advanced layout checkbox">
  <div>
