...
<CodePreview importFlowbiteReact="Button" title="Default button group">
  <Button.Group>
...
<CodePreview importFlowbiteReact="Button" title="With icons">
  <Button.Group>
    <Button color="gray">
...
<CodePreview importFlowbiteReact="Button" title="Outline" className="flex flex-wrap gap-2">
...
<CodePreview importFlowbiteReact="Button" title="All colors" className="flex flex-wrap gap-2">
  <Button.Group>
...
<CodePreview importFlowbiteReact="Button" title="Outline with icons" className="flex flex-wrap gap-2">
  <Button.Group outline>
    <Button color="gray">
      <HiUserCircle className="mr-3 h-4 w-4" />
      Profile
