...
const ModalPage: FC = () => {
  ...
  return (
    ...
    >
      ...
      <CodePreview title="Dismissable modal">
      ...
      <CodePreview title="Pop-up modal">
      ...
      <CodePreview title="Form elements">
      ...
      <CodePreview title="Placement">
        <div className="flex flex-wrap gap-4">
          <div className="w-40">
            <Select
              defaultValue="center"
              onChange={(event: { target: { value: SetStateAction<string> } }) => setModalPlacement(event.target.value)}
            >
