...
<CodePreview importFlowbiteReact="Button, Checkbox, Label, TextInput" title="Default form">
...
<CodePreview importFlowbiteReact="Label, TextInput" title="Input sizing">
...
<CodePreview importFlowbiteReact="Label, TextInput" title="Disabled inputs">
  <div className="flex max-w-md flex-col gap-4">
...
<CodePreview importFlowbiteReact="Button, Checkbox, Label, TextInput" title="Shadow inputs">
  <form className="flex max-w-md flex-col gap-4">
    <div>
      <div className="mb-2 block">
...
<CodePreview importFlowbiteReact="Label, TextInput" title="Helper text">
...
<CodePreview importFlowbiteReact="Label, TextInput" title="Input element with icon on the left side">
  <div className="max-w-md">
    <div className="mb-2 block">
...
<CodePreview importFlowbiteReact="Label, TextInput" title="Input element with icon on the right side">
  <div className="max-w-md">
    <div className="mb-2 block">
      <Label htmlFor="email4" value="Your email" />
    </div>
...
<CodePreview importFlowbiteReact="Label, TextInput" title="Input element with icon on both sides">
  <div className="max-w-md">
    <div className="mb-2 block">
      <Label htmlFor="email4" value="Your email" />
    </div>
...
<CodePreview importFlowbiteReact="Label, TextInput" title="Input element with addon">
  <div className="max-w-md">
    <div className="mb-2 block">
...
<CodePreview importFlowbiteReact="Label, TextInput" title="Success and error validation">
  <div className="flex max-w-md flex-col gap-4">
    <div>
      <div className="mb-2 block">
...
<CodePreview importFlowbiteReact="Label, TextInput" title="Input colors">
  <div className="flex max-w-md flex-col gap-4">
    <div>
      <div className="mb-2 block">
...
<CodePreview importFlowbiteReact="Label, Textarea" title="Textarea element">
...
<CodePreview importFlowbiteReact="Label, Select" title="Select input">
...
<CodePreview importFlowbiteReact="Checkbox, Label" title="Checkbox element">
...
<CodePreview importFlowbiteReact="Label, Radio" title="Radio button">
...
<CodePreview importFlowbiteReact="FileInput, Label" title="File upload">
...
<CodePreview importFlowbiteReact="ToggleSwitch" title="Toggle switch element">
...
<CodePreview importFlowbiteReact="Label, RangeSlider" title="Range slider element">
  <div className="flex max-w-md flex-col gap-4">
    <div>
