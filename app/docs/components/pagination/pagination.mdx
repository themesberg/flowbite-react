...
<CodePreview importFlowbiteReact="Pagination" title="Table data navigation">
...
<CodePreview importFlowbiteReact="Pagination" title="Table data navigation with icons">
  <div className="flex items-center justify-center text-center">
    <Pagination
      currentPage={props.currentPage}
      layout="table"
...
<CodePreview importFlowbiteReact="Pagination" title="Control button text">
  <div className="flex items-center justify-center text-center">
    <Pagination
      currentPage={props.currentPage}
      layout="pagination"
