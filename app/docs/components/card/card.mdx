...
<CodePreview importFlowbiteReact="Button, Card" title="Card with action button">
...
<CodePreview importFlowbiteReact="Card, Dropdown" title="User profile card" className="max-w-sm">
  <Card>
...
<CodePreview
  importFlowbiteReact="Button, Card, Checkbox, Label, TextInput"
...
<CodePreview title="E-commerce card" className="max-w-sm">
  <Card imgAlt="Apple Watch Series 7 in colors pink, silver, and black" imgSrc="/images/products/apple-watch.png">
    <a href="#">
