...
const CardPage: FC = () => (
  <>
    ...
    <CodePreview title="Card with action button">
      <Card>
        <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          Noteworthy technology acquisitions 2021
        </h5>
    ...
    <CodePreview title="Card with decorative image" className="max-w-sm">
    ...
    <CodePreview title="Card with image with alt text" className="max-w-sm">
      <Card imgAlt="Meaningful alt text for an image that is not purely decorative" imgSrc="/images/blog/image-1.jpg">
        <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          Noteworthy technology acquisitions 2021
        </h5>
        <p className="font-normal text-gray-700 dark:text-gray-400">
    ...
    <CodePreview title="Horizontal card" className="max-w-sm">
    ...
    <CodePreview title="User profile card" className="max-w-sm">
      <Card>
        ...
        <div className="flex flex-col items-center pb-10">
          ...
          <div className="mt-4 flex space-x-3 lg:mt-6">
            <a
              href="#"
              className="inline-flex items-center rounded-lg bg-primary-700 px-4 py-2 text-center text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
            >
              Add friend
            </a>
            <a
    ...
    <CodePreview title="Card with form inputs" className="max-w-sm">
      <Card>
    ...
    <CodePreview title="E-commerce card" className="max-w-sm">
    ...
    <CodePreview title="Call to action card">
      <Card>
    ...
    <CodePreview title="Card with list" className="max-w-sm">
      <Card>
    ...
    <CodePreview title="Pricing card" className="max-w-sm">
      <Card>
        ...
        <button
          type="button"
          className="inline-flex w-full justify-center rounded-lg bg-primary-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-primary-700 focus:outline-none focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900"
        >
          Choose plan
        </button>
      </Card>
    </CodePreview>
    <CodePreview title="Crypto card" className="max-w-sm">
      <Card>
