...
<CodePreview importFlowbiteReact="Tabs" title="Default tabs">
...
<CodePreview importFlowbiteReact="Tabs" title="Tabs with underline">
...
<CodePreview importFlowbiteReact="Tabs" title="Tabs with icons">
...
<CodePreview importFlowbiteReact="Tabs" title="Pills tabs">
...
<CodePreview importFlowbiteReact="Tabs" title="Full width tabs">
...
Contacts
  ...
  <div className="pt-2 pb-4 text-sm text-gray-500 dark:text-gray-400">Active tab: {props.activeTab}</div>
  <Button.Group>
