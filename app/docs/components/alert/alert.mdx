...
<CodePreview importExternal="import { HiInformationCircle } from 'react-icons/hi';" title="Alert with icon">
...
<CodePreview importExternal="import { HiInformationCircle } from 'react-icons/hi';" title="Additional content">
...
<CodePreview importExternal="import { HiInformationCircle } from 'react-icons/hi';" title="All options">
  <Alert
