...
In this example, we use the indeterminate state to manage multiple checkboxes within a group or tree-like structure.

<Example name="forms.checkboxIndeterminate" />
