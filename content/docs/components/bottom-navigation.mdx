...
The bottom bar component can be used to allow menu items and certain control actions to be performed by the user through the use of a fixed bar positioning to the bottom side of your page.
